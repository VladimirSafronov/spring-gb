...
//  }
  ...
  /**
   * Настройка цепочки фильтров, в которой прописано какие ресурсы доступны ролям.
   * Source - объект jwt, описывающий токен.
   */
  @Bean
  SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
    ...
    return httpSecurity
        .authorizeHttpRequests(configurer -> configurer
            //чтобы иметь доступ к ресурсу,должна быть роль
            //важен порядок requestMatchers
