...
@Tag(name = "Person") //разбивает контроллеры на группы, используя имя тега
public class PersonController {

  // OpenAPI3 - спецификация которая описывает ручки (каким будет ответ на какой запрос)

  //осознанно не проксируется через сервер, чтобы не писать лишний код
